...
export class TicketFeedback {
  ...
  handleUpdate = async (id: string, columnName: string, value: string): Promise<boolean> =>{
    ...
    if (updateResponse.error == ErrorType.NoError) {
      this.CommonTicketFeedbackResponse = { error: ErrorType.NoError, ticket_feedback: this.CommonTicketFeedbackResponse.ticket_feedback.map(ticket_feedback => (ticket_feedback.id === id ? updateResponse.ticket_feedback : ticket_feedback)) };
      return true;
    } else {
