...
export class CommonPeopleToOrgRelationships {
  ...
  handleUpdate = async (id: string, columnName: string, value: string): Promise<boolean> => {
    const updateResponse = await fetchAs<CommonPeopleToOrgRelationshipUpdateRequest, CommonPeopleToOrgRelationshipUpdateResponse>('common-people-to-org-relationships/update-read', {
    ...
    if (updateResponse.error == ErrorType.NoError) {
      this.peopleToOrgRelationshipsResponse = { error: ErrorType.NoError, peopleToOrgRelationships: this.peopleToOrgRelationshipsResponse.peopleToOrgRelationships.map(peopleToOrgRelationship => (peopleToOrgRelationship.id === id ? updateResponse.peopleToOrgRelationship : peopleToOrgRelationship)) };
  ...
  async getList() {
    this.peopleToOrgRelationshipsResponse = await fetchAs<CommonPeopleToOrgRelationshipListRequest, CommonPeopleToOrgRelationshipListResponse>('common-people-to-org-relationships/list', {
      token: globals.globalStore.state.token,
    });
  }
            ...
            <div id="relationship_type-holder" class="form-input-item form-thing">
              ...
              <span class="form-thing">
                <select id="relationship_type" name="relationship_type" onInput={event => this.relationship_typeChange(event)}>
                    ...
                    <option value="Vendor" selected={this.newRelationship_type === "Vendor"}>Vendor</option>
                    <option value="Customer" selected={this.newRelationship_type === "Customer"}>Customer</option>
                    <option value="Investor" selected={this.newRelationship_type === "Investor"}>Investor</option>
                    <option value="Associate" selected={this.newRelationship_type === "Associate"}>Associate</option>
                    <option value="Employee" selected={this.newRelationship_type === "Employee"}>Employee</option>
                    <option value="Member" selected={this.newRelationship_type === "Member"}>Member</option>
                    <option value="Executive" selected={this.newRelationship_type === "Executive"}>Executive</option>
                    <option value="President/CEO" selected={this.newRelationship_type === "President/CEO"}>President/CEO</option>
                    <option value="Board of Directors" selected={this.newRelationship_type === "Board of Directors"}>Board of Directors</option>
                    <option value="Retired" selected={this.newRelationship_type === "Retired"}>Retired</option>
                    <option value="Other" selected={this.newRelationship_type === "Other"}>Other</option>
                </select>
              </span>
            </div>   
