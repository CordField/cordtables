...
export class WorkRecord{
  ...
  handleUpdate = async (id: number, columnName: string, value: string): Promise<boolean> =>{
    ...
    if (updateResponse.error == ErrorType.NoError) {
      this.CommonWorkEstimateResponse = { error: ErrorType.NoError, work_estimate: this.CommonWorkEstimateResponse.work_estimate.map(work_estimate => (work_estimate.id === id ? updateResponse.work_estimate : work_estimate)) };
      return true;
    } else {
