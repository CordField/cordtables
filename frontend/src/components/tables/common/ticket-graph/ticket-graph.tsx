...
export class TicketGraph {
  ...
  handleUpdate = async (id: string, columnName: string, value: string): Promise<boolean> => {
    ...
    if (updateResponse.error == ErrorType.NoError) {
      this.commonTicketGraphResponse = {
        error: ErrorType.NoError,
        ticket_graph: this.commonTicketGraphResponse.ticket_graph.map(ticket_graph => (ticket_graph.id === id ? updateResponse.ticket_graph : ticket_graph)),
      };
      return true;
    } else {
