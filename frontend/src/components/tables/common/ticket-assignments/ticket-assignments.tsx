...
export class TicketAssignment{
  ...
  handleUpdate = async (id: string, columnName: string, value: string): Promise<boolean> =>{
    ...
    if (updateResponse.error == ErrorType.NoError) {
      this.commonTicketAssignmentResponse = { error: ErrorType.NoError, ticket_assignment: this.commonTicketAssignmentResponse.ticket_assignment.map(ticket_assignment => (ticket_assignment.id === id ? updateResponse.ticket_assignment : ticket_assignment)) };
      return true;
    } else {
