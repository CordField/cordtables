            ...
            <div id="methodologies-holder" class="form-input-item form-thing">
              ...
              <span class="form-thing">
                <select id="methodologies" name="methodologies" onInput={event => this.methodologiesChange(event)}>
                  ...
                  <option value="Paratext" selected={this.newMethodologies === "Paratext"}>Paratext</option>
                  <option value="OtherWritten" selected={this.newMethodologies === "OtherWritten"}>OtherWritten</option>
                  <option value="Render" selected={this.newMethodologies === "Render"}>Render</option>
                  <option value="Audacity" selected={this.newMethodologies === "Audacity"}>Audacity</option>
                  <option value="AdobeAudition" selected={this.newMethodologies === "AdobeAudition"}>AdobeAudition</option>
                  <option value="OtherOralTranslation" selected={this.newMethodologies === "OtherOralTranslation"}>OtherOralTranslation</option>
                  <option value="StoryTogether" selected={this.newMethodologies === "StoryTogether"}>StoryTogether</option>
                  <option value="SeedCompanyMethod" selected={this.newMethodologies === "SeedCompanyMethod"}>SeedCompanyMethod</option>
                  <option value="OneStory" selected={this.newMethodologies === "OneStory"}>OneStory</option>
                  <option value="Craft2Tell" selected={this.newMethodologies === "Craft2Tell"}>Craft2Tell</option>
                  <option value="OtherOralStories" selected={this.newMethodologies === "OtherOralStories"}>OtherOralStories</option>
                  <option value="Film" selected={this.newMethodologies === "Film"}>Film</option>
                  <option value="SignLanguage" selected={this.newMethodologies === "SignLanguage"}>SignLanguage</option>
                  <option value="OtherVisual" selected={this.newMethodologies === "OtherVisual"}>OtherVisual</option>
                </select>
              </span>
            </div> 
            ...
            <div id="position-holder" class="form-input-item form-thing">
              ...
              <span class="form-thing">
                <select id="position" name="position" onInput={event => this.positionChange(event)}>
                  ...
                  <option value="ConsultantInTraining" selected={this.newPosition === "ConsultantInTraining"}>ConsultantInTraining</option>
                  <option value="ExegeticalFacilitator" selected={this.newPosition === "ExegeticalFacilitator"}>ExegeticalFacilitator</option>
                  <option value="LeadershipDevelopment" selected={this.newPosition === "LeadershipDevelopment"}>LeadershipDevelopment</option>
                  <option value="Mobilization" selected={this.newPosition === "Mobilization"}>Mobilization</option>
                  <option value="Personnel" selected={this.newPosition === "Personnel"}>Personnel</option>
                  <option value="Communication" selected={this.newPosition === "Communication"}>Communication</option>
                  <option value="Administration" selected={this.newPosition === "Administration"}>Administration</option>
                  <option value="Technology" selected={this.newPosition === "Technology"}>Technology</option>
                  <option value="Finance" selected={this.newPosition === "Finance"}>Finance</option>
                  <option value="LanguageProgramManager" selected={this.newPosition === "LanguageProgramManager"}>LanguageProgramManager</option>
                  <option value="Literacy" selected={this.newPosition === "Literacy"}>Literacy</option>
                  <option value="TranslationFacilitator" selected={this.newPosition === "TranslationFacilitator"}>TranslationFacilitator</option>
                  <option value="OralityFacilitator" selected={this.newPosition === "OralityFacilitator"}>OralityFacilitator</option>
                  <option value="ScriptureEngagement" selected={this.newPosition === "ScriptureEngagement"}>ScriptureEngagement</option>
                  <option value="OtherAttached" selected={this.newPosition === "OtherAttached"}>OtherAttached</option>
                  <option value="OtherTranslationCapacity" selected={this.newPosition === "OtherTranslationCapacity"}>OtherTranslationCapacity</option>
                  <option value="OtherPartnershipCapacity" selected={this.newPosition === "OtherPartnershipCapacity"}>OtherPartnershipCapacity</option>
                </select>
              </span>
            </div>
            ...
            <div id="status-holder" class="form-input-item form-thing">
              ...
              <span class="form-thing">
                <select id="status" name="status" onInput={event => this.statusChange(event)}>
                  ...
                  <option value="InDevelopment" selected={this.newStatus === "InDevelopment"}>InDevelopment</option>
                  <option value="DidNotDevelop" selected={this.newStatus === "DidNotDevelop"}>DidNotDevelop</option>
                  <option value="Active" selected={this.newStatus === "Active"}>Active</option>
                  <option value="DiscussingTermination" selected={this.newStatus === "DiscussingTermination"}>DiscussingTermination</option>
                  <option value="DiscussingReactivation" selected={this.newStatus === "DiscussingReactivation"}>DiscussingReactivation</option>
                  <option value="DiscussingChangeToPlan" selected={this.newStatus === "DiscussingChangeToPlan"}>DiscussingChangeToPlan</option>
                  <option value="DiscussingSuspension" selected={this.newStatus === "DiscussingSuspension"}>DiscussingSuspension</option>
                  <option value="FinalizingCompletion" selected={this.newStatus === "FinalizingCompletion"}>FinalizingCompletion</option>
                  <option value="ActiveChangedPlan" selected={this.newStatus === "ActiveChangedPlan"}>ActiveChangedPlan</option>
                  <option value="Suspended" selected={this.newStatus === "Suspended"}>Suspended</option>
                  <option value="Terminated" selected={this.newStatus === "Terminated"}>Terminated</option>
                  <option value="Completed" selected={this.newStatus === "Completed"}>Completed</option>
                  <option value="Converted" selected={this.newStatus === "Converted"}>Converted</option>
                  <option value="Unapproved" selected={this.newStatus === "Unapproved"}>Unapproved</option>
                  <option value="Transferred" selected={this.newStatus === "Transferred"}>Transferred</option>
                  <option value="NotRenewed" selected={this.newStatus === "NotRenewed"}>NotRenewed</option>
                  <option value="Rejected" selected={this.newStatus === "Rejected"}>Rejected</option>
                </select>
              </span>
            </div> 
