          ...
          <form class="form-thing">
            ...
            <div id="step-holder" class="form-input-item form-thing">
              ...
              <select id="step" name="step"  onInput={event => this.stepChange(event)}>
                  ...
                  <option value="EarlyConversations" selected={this.newStep === "EarlyConversations"}>EarlyConversations</option>
                  <option value="PendingConceptApproval" selected={this.newStep === "PendingConceptApproval"}>PendingConceptApproval</option>
                  <option value="PrepForConsultantEndorsement" selected={this.newStep === "PrepForConsultantEndorsement"}>PrepForConsultantEndorsement</option>
                  <option value="PendingConsultantEndorsement" selected={this.newStep === "PendingConsultantEndorsement"}>PendingConsultantEndorsement</option>
                  <option value="PrepForFinancialEndorsement" selected={this.newStep === "PrepForFinancialEndorsement"}>PrepForFinancialEndorsement</option>
                  <option value="PendingFinancialEndorsement" selected={this.newStep === "PendingFinancialEndorsement"}>PendingFinancialEndorsement</option>
                  <option value="FinalizingProposal" selected={this.newStep === "FinalizingProposal"}>FinalizingProposal</option>
                  <option value="PendingRegionalDirectorApproval" selected={this.newStep === "PendingRegionalDirectorApproval"}>PendingRegionalDirectorApproval</option>
                  <option value="PendingZoneDirectorApproval" selected={this.newStep === "PendingZoneDirectorApproval"}>PendingZoneDirectorApproval</option>
                  <option value="PendingFinanceConfirmation" selected={this.newStep === "PendingFinanceConfirmation"}>PendingFinanceConfirmation</option>
                  <option value="OnHoldFinanceConfirmation" selected={this.newStep === "OnHoldFinanceConfirmation"}>OnHoldFinanceConfirmation</option>
                  <option value="DidNotDevelop" selected={this.newStep === "DidNotDevelop"}>DidNotDevelop</option>
                  <option value="Rejected" selected={this.newStep === "Rejected"}>Rejected</option>
                  <option value="Active" selected={this.newStep === "Active"}>Active</option>
                  <option value="ActiveChangedPlan" selected={this.newStep === "ActiveChangedPlan"}>ActiveChangedPlan</option>
                  <option value="DiscussingChangeToPlan" selected={this.newStep === "DiscussingChangeToPlan"}>DiscussingChangeToPlan</option>
                  <option value="PendingChangeToPlanApproval" selected={this.newStep === "PendingChangeToPlanApproval"}>PendingChangeToPlanApproval</option>
                  <option value="PendingChangeToPlanConfirmation" selected={this.newStep === "PendingChangeToPlanConfirmation"}>PendingChangeToPlanConfirmation</option>
                  <option value="DiscussingSuspension" selected={this.newStep === "DiscussingSuspension"}>DiscussingSuspension</option>
                  <option value="PendingSuspensionApproval" selected={this.newStep === "PendingSuspensionApproval"}>PendingSuspensionApproval</option>
                  <option value="Suspended" selected={this.newStep === "Suspended"}>Suspended</option>
                  <option value="DiscussingReactivation" selected={this.newStep === "DiscussingReactivation"}>DiscussingReactivation</option>
                  <option value="PendingReactivationApproval" selected={this.newStep === "PendingReactivationApproval"}>PendingReactivationApproval</option>
                  <option value="DiscussingTermination" selected={this.newStep === "DiscussingTermination"}>DiscussingTermination</option>
                  <option value="PendingTerminationApproval" selected={this.newStep === "PendingTerminationApproval"}>PendingTerminationApproval</option>
                  <option value="FinalizingCompletion" selected={this.newStep === "FinalizingCompletion"}>FinalizingCompletion</option>
                  <option value="Terminated" selected={this.newStep === "Terminated"}>Terminated</option>
                  <option value="Completed" selected={this.newStep === "Completed"}>Completed</option>
