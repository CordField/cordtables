...
export class SilTableOfLanguagesInCountrys {
  ...
  async getList(page) {
    this.tableOfLanguagesInCountriesResponse = await fetchAs<SilTableOfLanguagesInCountryListRequest, SilTableOfLanguagesInCountryListResponse>(
      'sil/table-of-languages-in-country/list',
      {
  ...
  render() {
    return (
      <Host>
        <slot></slot>
        {/* table abstraction */}
        {this.tableOfLanguagesInCountriesResponse && (
          <cf-table rowData={this.tableOfLanguagesInCountriesResponse.tableOfLanguagesInCountries} columnData={this.columnData}></cf-table>
        )}
        <cf-pagination
          current-page={this.currentPage}
          total-rows={this.tableOfLanguagesInCountriesResponse.size}
          results-per-page="50"
          page-url="table-of-languages-in-country"
        ></cf-pagination>
