...
data class AdminRolesListRequest(
    val token: String?
)
...
class List(
    ...
    fun listHandler(@RequestBody req:AdminRolesListRequest): AdminRolesListResponse {
        ...
        try {
            ...
            return AdminRolesListResponse(ErrorType.SQLReadError, mutableListOf())
        }

        return AdminRolesListResponse(ErrorType.NoError, data)
    }
}
