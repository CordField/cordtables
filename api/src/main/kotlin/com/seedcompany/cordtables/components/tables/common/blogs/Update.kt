...
class Update(
    ...
    fun updateHandler(@RequestBody req: ScLanguagesUpdateRequest): ScLanguagesUpdateResponse {
        ...
        if (req.column.equals("multiple_blogs_leverage_linguistic_level") && req.value != null && !enumContains<MultipleLanguagesLeverageLinguisticScale>(
                        req.value as String
                )
        ) {
            return ScLanguagesUpdateResponse(
        ...
        if (req.column.equals("multiple_blogs_leverage_joint_training_level") && req.value != null && !enumContains<MultipleLanguagesLeverageJointTrainingScale>(
                        req.value as String
                )
        ) {
            return ScLanguagesUpdateResponse(
        ...
        if (req.column.equals("lang_comm_int_in_blog_development_level") && req.value != null && !enumContains<LangCommIntInLanguageDevelopmentScale>(
                        req.value as String
                )
        ) {
            return ScLanguagesUpdateResponse(
        ...
        when (req.column) {
            ...
            "first_blog_population" -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "first_blog_population",
                        id = req.id,
                        value = req.value,
                )
                util.updateField(
            ...
            "multiple_blogs_leverage_linguistic_level" -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_linguistic_level",
                        id = req.id,
                        value = req.value,
                        cast = "::sc.multiple_blogs_leverage_linguistic_scale",
                )
                ...
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_linguistic_value",
                        id = req.id,
            ...
            "multiple_blogs_leverage_linguistic_description"
            -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_linguistic_description",
                        id = req.id,
                        value = req.value,
                )
            }

            "multiple_blogs_leverage_linguistic_source" -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_linguistic_source",
                        id = req.id,
                        value = req.value,
                )
            }
            ...
            "multiple_blogs_leverage_joint_training_level" -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_joint_training_level",
                        id = req.id,
                        value = req.value,
                        cast = "::sc.multiple_blogs_leverage_joint_training_level",
                )
                ...
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_joint_training_value",
                        id = req.id,
            ...
            "multiple_blogs_leverage_joint_training_description"
            -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_joint_training_description",
                        id = req.id,
                        value = req.value,
                )
            }

            "multiple_blogs_leverage_joint_training_source" -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "multiple_blogs_leverage_joint_training_source",
                        id = req.id,
                        value = req.value,
                )
            }
            ...
            "lang_comm_int_in_blog_development_level" -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "lang_comm_int_in_blog_development_level",
                        id = req.id,
                        value = req.value,
                        cast = "::sc.lang_comm_int_in_blog_development_scale",
                )
                ...
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "lang_comm_int_in_blog_development_value",
                        id = req.id,
            ...
            "lang_comm_int_in_blog_development_description"
            -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "lang_comm_int_in_blog_development_description",
                        id = req.id,
                        value = req.value,
                )
            }

            "lang_comm_int_in_blog_development_source" -> {
                util.updateField(
                        token = req.token,
                        table = "common.blogs",
                        column = "lang_comm_int_in_blog_development_source",
                        id = req.id,
                        value = req.value,
                )
            }
