            ...
            while (jdbcResult.next()) {
                ...
                data.add(
                    globalPartnerEngagement(
                        ...
                        type = if (type == null) null else InvolvementOptions.valueOf(type),
                        mou_start = mou_start,
                        mou_end = mou_end,
                        sc_roles = if (sc_roles == null) null else GlobalPartnerRoles.valueOf(sc_roles),
                        partner_roles = if (partner_roles == null) null else GlobalPartnerRoles.valueOf(partner_roles),
