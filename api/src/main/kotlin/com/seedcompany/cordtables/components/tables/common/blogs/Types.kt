...
data class Language(
    ...
    val sign_blog_code: String? = null,
    ...
    val first_blog_population: Int? = null,
    ...
    val multiple_blogs_leverage_linguistic_level: MultipleLanguagesLeverageLinguisticScale? = null,
    val multiple_blogs_leverage_linguistic_value: Double? = null,
    val multiple_blogs_leverage_linguistic_description: String? = null,
    val multiple_blogs_leverage_linguistic_source: String? = null,
    val multiple_blogs_leverage_joint_training_level: MultipleLanguagesLeverageJointTrainingScale? = null,
    val multiple_blogs_leverage_joint_training_value: Double? = null,
    val multiple_blogs_leverage_joint_training_description: String? = null,
    val multiple_blogs_leverage_joint_training_source: String? = null,
    val lang_comm_int_in_blog_development_level: LangCommIntInLanguageDevelopmentScale? = null,
    val lang_comm_int_in_blog_development_value: Double? = null,
    val lang_comm_int_in_blog_development_description: String? = null,
    val lang_comm_int_in_blog_development_source: String? = null,
