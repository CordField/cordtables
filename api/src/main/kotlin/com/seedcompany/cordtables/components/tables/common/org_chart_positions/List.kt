...
data class CommonOrgChartPositionsListRequest(
    val token: String?
)

data class CommonOrgChartPositionsListResponse(
    val error: ErrorType,
    val orgChartPositions: MutableList<orgChartPosition>?
)

@CrossOrigin(origins = ["http://localhost:3333", "https://dev.cordtables.com", "https://cordtables.com", "*"])
@Controller("CommonOrgChartPositionsList")
class List(
    @Autowired
    val util: Utility,
    ...
    fun listHandler(@RequestBody req:CommonOrgChartPositionsListRequest): CommonOrgChartPositionsListResponse {
        ...
        if (req.token == null) return CommonOrgChartPositionsListResponse(ErrorType.TokenNotFound, mutableListOf())
        ...
        try {
            ...
            return CommonOrgChartPositionsListResponse(ErrorType.SQLReadError, mutableListOf())
        }

        return CommonOrgChartPositionsListResponse(ErrorType.NoError, data)
    }
}
