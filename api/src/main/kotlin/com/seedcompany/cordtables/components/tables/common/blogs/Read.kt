...
class Read(
    ...
    fun readHandler(@RequestBody req: CommonBlogsReadRequest): CommonBlogsReadResponse {
        ...
        if (req.token == null) return CommonBlogsReadResponse(ErrorType.TokenNotFound)
            ...
            while (jdbcResult.next()) {
                ...
                val blog =
                        Blog(
                                ...
                                lang_comm_int_in_blog_development_level = if (lang_comm_int_in_blog_development_level == null) null else LangCommIntInLanguageDevelopmentScale.valueOf(
