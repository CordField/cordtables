...
data class Language(
  ...
  val has_external_first_scripture: Boolean? = null,
  val first_scripture_engagement: Int? = null,
...
//    var id: Int? = null,
  ...
  val display_name_pronunciation: String?,
  val ethnologue: String?,
  val has_external_first_scripture: Boolean? = false,
  val is_dialect: Boolean? = false,
  val is_sign_language: Boolean? = false,
  val is_least_of_these: Boolean?,
  val least_of_these_reason: String?,
  val name: String,
  val population_override: Int?,
  val registry_of_dialects_code: String?,
  val sensitivity: CommonSensitivity?,
  val sign_language_code: String?,
  val sponsor_estimated_end_date: String?,
