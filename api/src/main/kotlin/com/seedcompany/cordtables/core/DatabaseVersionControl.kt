...
class DatabaseVersionControl(
  ...
  private fun loadCountryCodes(adminPeopleId: Int) {
  ...
  private fun loadLanguageCodes(adminPeopleId: Int) {
  ...
  private fun loadLanguageIndexes(adminPeopleId: Int) {
  ...
  private fun loadIso_639_3_Name_Index(adminPeopleId: Int) {
  ...
  private fun loadIso_639_3(adminPeopleId: Int) {
  ...
  private fun loadIso_639_3_Retirements(adminPeopleId: Int) {
  ...
  private fun loadIso_639_3_Macrolanguages(adminPeopleId: Int) {
