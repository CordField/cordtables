	...
	owning_group int
      ...
      begin
          insert into sc.languages_ex_history(
            ...
            egids_level ,
            egids_value,
            least_reached_progress_jps_scale ,
            least_reached_value,
            partner_interest_value ,
            partner_interest_description ,
            partner_interest_source ,
            multiple_language_leverage_linguistic_value ,
            multiple_language_leverage_linguistic_description ,
            multiple_language_leverage_linguistic_source ,
            multiple_language_leverage_joint_training_value ,
            multiple_language_leverage_joint_training_description ,
            multiple_language_leverage_joint_training_source ,
          ...
          values (
          	...
          	new.egids_level ,
          	new.egids_value,
          	new.least_reached_progress_jps_scale ,
          	new.least_reached_value,
          	new.partner_interest_value ,
          	new.partner_interest_description ,
          	new.partner_interest_source ,
          	new.multiple_language_leverage_linguistic_value ,
          	new.multiple_language_leverage_linguistic_description ,
          	new.multiple_language_leverage_linguistic_source ,
          	new.multiple_language_leverage_joint_training_value ,
            new.multiple_language_leverage_joint_training_description ,
            new.multiple_language_leverage_joint_training_source ,
